...
<style>
  .sim-table { border-collapse: collapse; width: 100%; margin: 16px 0; }
  .sim-table th, .sim-table td { border: 1px solid #ddd; padding: 10px 14px; text-align: left; }
  .sim-table th { background: #f6f8fa; font-weight: 600; }
  .sim-table tr:hover { background: #f9f9f9; }
  .sim-table a { color: #4183C4; text-decoration: none; font-weight: 600; }
  .sim-table a:hover { text-decoration: underline; }
</style>
...
<table class="sim-table">
  ...
  <tbody>
    <tr>
      <td><a href="https://vikasrajput.github.io/storage-simulator/simulators/blob-partition-simulator.html">Blob Storage</a></td>
      <td>Will my blob naming pattern create a hot partition server? Compares 6 naming strategies, visualizes partition spread.</td>
    </tr>
    <tr>
      <td><a href="https://vikasrajput.github.io/storage-simulator/simulators/table-partition-simulator.html">Table Storage</a></td>
      <td>Will my PartitionKey bottleneck under load? Simulates 6 key strategies, flags partitions exceeding 2,000 ops/sec.</td>
    </tr>
    <tr>
      <td><a href="https://vikasrajput.github.io/storage-simulator/simulators/files-partition-simulator.html">Azure Files</a></td>
